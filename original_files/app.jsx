      ...
      >
        ...
        <div className="nodes-layer" style={{ width: `${W}px`, height: `${H}px` }}>
          ...
          <AxisNode
            ...
            captionTop={axisY + 150}
            label="EARTH"
            sub={`${window.seasonFromDate(d, state.lat).toLowerCase()} · ${window.zodiacFromDate(d).toLowerCase()}`}
            caption={window.formatCoords(state.lat, state.lon)}
            showCaption={tweaks.showCaptions}
          >
            <NodeEarth
          ...
          <AxisNode
            ...
            label="SOLAR SYSTEM"
            sub="Sol · 8 planets"
            caption={`Sun in ${window.zodiacFromDate(d)}`}
            showCaption={tweaks.showCaptions}
          >
            <NodeSolarSystem
